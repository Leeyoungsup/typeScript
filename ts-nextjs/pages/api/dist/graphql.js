...
var typeDefs = apollo_server_micro_1.gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  type User {\n    id: ID!\n    firstName: String!\n    lastName: String!\n    blog: String\n    stars: Int\n  }\n\n  type Query {\n    users: [User]!\n  }\n"], ["\n  type User {\n    id: ID!\n    firstName: String!\n    lastName: String!\n    blog: String\n    stars: Int\n  }\n\n  type Query {\n    users: [User]!\n  }\n"])));
var resolvers = {
    Query: {
        users: function (_parent, _args, _context, _info) {
            return _context.db
                .collection('users')
                .findOne()
                .then(function (data) {
    ...
    context: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    dbClient = new mongodb_1.MongoClient(process.env.MONGO_DB_URI, {
                        useNewUrlParser: true,
                        useUnifiedTopology: true
                    });
                    if (!!dbClient.isConnected()) return [3 /*break*/, 3];
                ...
                case 4:
                    e_1 = _a.sent();
                    console.log('--->error while connecting via graphql context (db)', e_1);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/, { db: db }];
            }
        });
    }); }
});
