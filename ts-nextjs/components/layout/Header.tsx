    ...
    <>
      <nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        ...
        <Link href="/" className="flex items-center">
            <span className="self-center text-2xl hover:text-purple-700 whitespace-nowrap dark:text-white text-purple-500">스마트헬스케어플랫폼</span>
        </Link>
        <div className="flex md:order-2">
            <div className="flex items-center">
                <a href="#"className="mr-6 text-sm font-medium text-gray-500 dark:text-white hover:underline">UserName</a>
